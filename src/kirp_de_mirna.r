...
tumour <- read.csv('/Users/emanuel/Projects/projects/frezza_fh/tables/kirp_mirna_tumour.txt', sep='\t', row.names=1)
...
# -- Export results
write.table(res, '/Users/emanuel/Projects/projects/frezza_fh/tables/kirp_mirna_limma_tumour_vs_normal.txt', sep='\t', quote=F, row.names=F)
