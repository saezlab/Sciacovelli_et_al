...
tumour <- read.csv('/Users/emanuel/Projects/projects/frezza_fh/tables/kirp_tumour.txt', sep='\t', row.names=1)[fh_mutants]
...
# -- Export results
write.table(res, '/Users/emanuel/Projects/projects/frezza_fh/tables/kirp_limma_fhmutant_vs_normal.txt', sep='\t', quote=F, row.names=F)
